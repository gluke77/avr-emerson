...
{
	sprintf(lcd_line0, "ÀÄÐÅÑ ÓÑÒÐÎÉÑÒÂÀ");
...
void menu_usart0_baudrate(void)
{
	...
	sprintf(lcd_line0, "ÑÊÎÐÎÑÒÜ ÏÎÐÒÀ  ");
...
void menu_usart1_baudrate(void)
{
	...
	sprintf(lcd_line0, "ÑÊÎÐÎÑÒÜ ÏÎÐÒÀ  ");
	sprintf(lcd_line1, "ÏÐÈÍÒÅÐÀ:%-6ld ", g_usart1_baudrate);
...
void menu_store_settings(void)
{
	...
	{
		storeToEE();
		sprintf(lcd_line0, "ÓÑÒÀÍÎÂÊÈ       ");
		sprintf(lcd_line1, "ÑÎÕÐÀÍÅÍÛ       ");
	...
	sprintf(lcd_line0, "ÑÎÕÐÀÍÈÒÜ       ");
	sprintf(lcd_line1, "ÓÑÒÀÍÎÂÊÈ       ");
...
void menu_reset_settings(void)
{
	if (KEY_PRESSED(KEY_ENTER))
	{
		reset_settings();
		storeToEE();
		sprintf(lcd_line0, "ÇÀÂÎÄÑÊÈÅ ÓÑÒÀÍ.");
		sprintf(lcd_line1, "ÂÎÑÑÒÀÍÎÂËÅÍÛ   ");
		lcd_puts(0, lcd_line0);
		lcd_puts(1, lcd_line1);
		beep_ms(500);
		_delay_ms(500);
	...
	sprintf(lcd_line0, "ÂÎÑÑÒÀÍÎÂÈÒÜ    ");
	sprintf(lcd_line1, "ÇÀÂÎÄÑÊÈÅ ÓÑÒÀÍ.");
